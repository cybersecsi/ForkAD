        ...
        <>
          ...
          <div className='flex flex-col gap-4 mt-4'>
            {liveEvents.map((liveEvent: ICtfFlagStolen, key: number) => {
              ...
              const task = ctfTasks.find(
                (task: ICtfTask) => task.id === liveEvent.task_id,
              ) as ICtfTask;
              ...
              return (
                ...
                >
                  ...
                  <p>
                    <b>Team {attacker.name}</b> stole a flag from <b>Team {victim.name}</b> on
                    service <b>{task.name}</b>. <br />
                  </p>
